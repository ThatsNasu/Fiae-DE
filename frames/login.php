	...
	<?php
		...
		if(isset($_POST['user']) && isset($_POST['pass']) && !empty($_POST['user']) && !empty($_POST['pass'])) {
			...
			if($data['pass'] === hash('sha256', $_POST['pass']) && $data['active'] == 1) {
				...
				echo '<meta http-equiv="refresh" content="0; URL=https://fiaede.dasnasu.bitbite.dev/Controlpanel">';
			} elseif(!$data) {
				echo '<meta http-equiv="refresh" content="0; URL=https://fiaede.dasnasu.bitbite.dev/Loginerror?c=notcreated">';
			} elseif($data['active'] != 1) {
				echo '<meta http-equiv="refresh" content="0; URL=https://fiaede.dasnasu.bitbite.dev/Loginerror?c=inactive">';
			} else {
