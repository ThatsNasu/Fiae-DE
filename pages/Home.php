        ...
        <?php
            if(Helpers::isLoggedIn()) {
                ...
                foreach($recentFiles as $file) {
                    ...
                    echo '<div class="recentFile">'.$creator.' uploaded <a download href="/pages/get.php?f='.$file->getID().'">'.$file->getFilename().'</a> in category <a href="'.Helpers::getFullPathByCategoryID($file->getCategory(), $categories).'" target="_blank" rel="noopener">'.Helpers::getCategoryByID($file->getCategory(), $categories)->getLabel().'</a></div>';
                }
            }
        ?>
    </article>
